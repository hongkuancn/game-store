...
|3rd party login|Extra|100|<p align="left">Users can use Google Login to the 2333 platform. If Google Login is used, the user must choose his/her role on the 2333 platform, namely either user or developer.|
|Own game|Extra|100|<p align="left">1. We implemented our own game with high-score, save, load, start and restart features. After testing it several times, all of above features worked fine in the database which can prove that communications are working well.<br>2. It is a fun Puzzle game, it also depends a little on lucky. We believe our game is interesting and commendable.<br>3. The url of our game is: http://stupendous-shake.surge.sh|
...
|Social media sharing |Extra|50|<p align="left">Social media sharing is enabled for Facebook and Twitter. Players and players only can share the game information, note that the game must be bought first. The player does not need to log in for Facebook or Twitter if his/her account is being recognized by the browser. Game information and profile picture will be automatically loaded to the post.
